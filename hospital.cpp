        ...
        void addPatient()
    {
        ...
        cout << "Patient is added successfully\n";
          ...
          void displayPatientinfo() {
              ...
              {
                  cout << "patient name is: " << patients[i].name << "\n";
                  cout << "patient ID is: " << patients[i].id << "\n";
                  cout << "patient age is: " << patients[i].age << "\n";
                  cout << "patient gender is: " << patients[i].gender << "\n";
                  cout << "patient illness is: " << patients[i].illness << "\n";
                  cout << "patient doctor is: " << patients[i].doctorname << "\n";
                  cout << "patient department is: " << patients[i].department << "\n";
                  cout << "==================================\n";
              ...
              void displayDoctorinfo() {
                  ...
                  {
                      cout << "Doctor name is: " << doctors[i].name << "\n";
                      cout << "Doctor id is: " << doctors[i].id << "\n";
                      cout << "Doctor department is: " << doctors[i].department << "\n";
                  }
                  cout << "=============================";
              }
              void searchPatient() {
              ...
              void deletePatient()
              {
                  ...
                  for (int i =0; i< patients.size(); i++)
                  {
                      if (patients[i].id == id)
                      {
                          cout << "patient " << patients[i].name << " is deleted successfully\n";
